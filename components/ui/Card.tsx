...
export default function Card({ image, title, description, buttonText, buttonHref }: CardProps) {
  return (
    <div className="bg-white shadow-lg overflow-hidden flex flex-row w-full mx-auto transition-all duration-500 ease-in-out hover:shadow-2xl hover:scale-105 hover:-translate-y-2 cursor-pointer hover:bg-[var(--blue)] group h-80">
