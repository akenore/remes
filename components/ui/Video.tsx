...
export default function Video() {
     ...
     return (
          <div className="max-w-5xl mx-2 sm:mx-4 md:mx-5 xl:mx-auto rounded-sm overflow-hidden -mt-10 sm:-mt-28 md:-mt-56 lg:-mt-72 2xl:-mt-96">
               <div className="relative group cursor-pointer" onClick={handlePlayClick}>
                    ...
                    >
                         ...
                         <source src="https://cdn.strakon.fr/videos/strakon-presentation.mp4" type="video/mp4" />
