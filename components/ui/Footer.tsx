     ...
     return (
          <footer className="w-full h-[1220px] lg:h-[1330px] bg-cover bg-top bg-[url('/footer/bg-mobile.jpg')] sm:bg-[url('/footer/bg-desktop.jpg')] bg-no-repeat">
               <div className="flex flex-col items-center justify-center pt-96">
                    <Image src="/logo-footer.png" alt="Remes" width={335} height={263} className="w-1/2 md:w-full" />
               </div>
               <div className="grid grid-cols-3 gap-4 mt-10">
                    <div className="col-span-4 md:col-span-2">
                         <p className="text-white font-[var(--font-myanmar)] mb-8 mx-2 md:mx-auto text-center md:text-left">
